...
hinputFile    = uicontrol('Style','edit',...
             'String','S:\Consulting\CSR\Invoice Validation\1702\1702 Origin Invoice Validation.xlsm','Position',[155,160,440,25] );
...
hdate4_d    = uicontrol('Style','edit',...
             'String','1','Position',[155,130,30,25] );
hdate4_m    = uicontrol('Style','edit',...
             'String','12','Position',[185,130,30,25]);
hdate4_y    = uicontrol('Style','edit',...
             'String','2016','Position',[220,130,40,25]);
...
hdate5_nPeriods    = uicontrol('Style','edit',...
             'String','6','Position',[155,100,60,25] );         
         
htext6  = uicontrol('Style','text','String','Output File: ', ...
                'FontWeight','bold','Position',[5,70,150,25]);

houtputFile    = uicontrol('Style','edit',...
             'String','S:\Consulting\CSR\Invoice Validation\1702\MeterData_CSR_20170210.xlsx','Position',[155,70,440,25] );
