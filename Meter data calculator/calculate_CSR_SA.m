...
HistStartDate = datenum(2015,5,1);
HistEndDate = datenum(2016,5,1);
...
%% Meter list
XL_FILE = 'C:\Users\james.cheong\Desktop\CSR\SA Power NTR 2016-07-14.xlsm';
...
xlswrite('MeterDataCSR.xlsx', res2, 'Sheet1');