...
%% Meter list
% XL_FILE = 'S:\Consulting\Tasmanian Water and Sewerage Corporation\Invoice Validation\201609\InvoiceValidation Sep 16.xlsm';
% XL_FILE = 'S:\Consulting\Tasmanian Water and Sewerage Corporation\1610 Saving Tracker\Saving Tracker 1610.xlsm';
XL_FILE = 'S:\Consulting\PACT Group\1611 Energy Accounting Tenderer\Cost Outlook.xlsm';

% Meter List
[n,t,r] = xlsread(XL_FILE,'Meter list','B:P');
...
xlswrite('MeterDataPACT.xlsx', res2, 'Sheet1');
